...
\title[全路网智能路径规划]{本科毕业论文答辩：全路网智能路径规划} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\begin{itemize}
\item 在一个地图中，给定起点$S$和终点$E$，在某一特定的评估模型（Metric Function）下，给出最优路径
\end{itemize}
如下图所示，给定
\end{frame}
